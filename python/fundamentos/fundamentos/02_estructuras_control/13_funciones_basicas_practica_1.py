...
#Esta función genera un error porque la función "cantidad_de_dias_en_el_anio" no esta definida 
...
#
#Salida :2022
#El segundo return no llega a ejecutarse
...
#x         | None
#Salida :24
# x no imprime nada porque el valor no es retornable
